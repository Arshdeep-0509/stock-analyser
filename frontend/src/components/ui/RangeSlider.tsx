...
export interface RangeSliderProps {
  ...
  className?: string
  /** Names the two handles "Minimum <label>" / "Maximum <label>". Two sliders on one screen need distinct labels, or a screen reader can't tell them apart. */
  label?: string
}
...
export function RangeSlider({ min, max, valueMin, valueMax, onChange, className, label = 'RSI' }: RangeSliderProps) {
  return (
